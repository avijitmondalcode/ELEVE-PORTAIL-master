...
public class FacultyViewAttendanceAdapter extends RecyclerView.Adapter<FacultyViewAttendanceAdapter.ViewHolder> {
    public List<FacultyAttendanceList> facultyAttendanceLists;
    Context context;
    FirebaseFirestore firebaseFirestore;
    FirebaseAuth auth;
    //String UserId;
    public FacultyViewAttendanceAdapter(List<FacultyAttendanceList> facultyAttendanceLists) {
        this.facultyAttendanceLists = facultyAttendanceLists;
    }

    @NonNull
    @Override
    public FacultyViewAttendanceAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FacultyViewAttendanceAdapter.ViewHolder holder, int position) {
